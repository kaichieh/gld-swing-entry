...
- it can be extended later into simple backtests and trading-rule comparisons
...
- The old three-bucket and ranking branches have been retired; their historical results remain in `results.tsv`, but the exploratory round scripts and intermediate summary tables are no longer part of the formal pipeline.
